...
To build the final jar and optimize the caseManagement application for production, run:
...
[service discovery and configuration with consul]: https://www.jhipster.tech/documentation-archive/v7.0.0/microservices-architecture/#consul
