...
public interface RequirementManagementServiceClient {
	...
	List<AttributeDTO> getAttributesFromRequirementManagement(@RequestParam(value = "active.equals") Boolean active);
...
/*    @RequestMapping(value = "/api/attributes")
	...
	List<ExtensionKeyDTO> getAllExtensionKeysFromRequirementManagement(
			@RequestParam(value = "active.equals") Boolean active);
