 ...
 * <ul>
 * <li>We want to keep a lazy association between the appUser and the authorities, because people will
 * quite often do relationships with the appUser, and we don't want them to get the authorities all
...
public class UserResource {
    ...
    /**
     * {@code GET /users/:login} : get the "login" appUser.
     *
     * @param login the login of the appUser to find.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the "login" appUser, or with status {@code 404 (Not Found)}.
     */
