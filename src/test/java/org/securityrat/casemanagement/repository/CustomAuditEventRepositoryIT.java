...
import static org.securityrat.casemanagement.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
public class CustomAuditEventRepositoryIT {
    ...
    public void setup() {
        ...
        testUserEvent.setPrincipal("test-appUser");
        ...
        testOldUserEvent.setPrincipal("test-appUser");
        ...
        testOtherUserEvent.setPrincipal("other-test-appUser");
    ...
    public void addAuditEvent() {
        ...
        data.put("test-key", "test-value");
        AuditEvent event = new AuditEvent("test-appUser", "test-type", data);
    ...
    public void addAuditEventWithAuthorizationFailureType() {
        Map<String, Object> data = new HashMap<>();
        data.put("test-key", "test-value");
        AuditEvent event = new AuditEvent("test-appUser", "AUTHORIZATION_FAILURE", data);
        customAuditEventRepository.add(event);
        List<PersistentAuditEvent> persistentAuditEvents = persistenceAuditEventRepository.findAll();
        assertThat(persistentAuditEvents).hasSize(0);
    }
